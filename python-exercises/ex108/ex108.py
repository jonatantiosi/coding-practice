'''
108 — Criando um navegador automatizado com Selenium
Tarefa: crie um script que use o Selenium para abrir https://www.google.com e
busque por "Python".
Conceitos: Selenium, automação de navegador, WebDriver, interação com
elementos.'''
