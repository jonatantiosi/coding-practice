...
print(os.path.exists(r'C:\Users\Jonatan\Desktop\PythonCoding\UdemyPython'))
print()

print(os.path.abspath('.'))  # absolute path, pra retornar o caminho atual
print()
...
print(os.path.dirname(caminho))  # nome do diretorio
