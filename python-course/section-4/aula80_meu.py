...
def encontra_duplicata(lista_inteiros):
    ...
    for numero in lista_inteiros:
        ...
        if numero not in numeros_verificados:
            numeros_verificados.add(numero)
        elif numero in numeros_verificados:
...
for i, lista in enumerate(lista_de_listas_de_inteiros):
    primero_duplicado = encontra_duplicata(lista)
    print(f'primeiro duplicado da lista {i}: {primero_duplicado}')
