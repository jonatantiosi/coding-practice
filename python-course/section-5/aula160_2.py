...
# Professor prefere essa maneira
class Carta(NamedTuple):
    valor: str = 'VALOR'
    naipe: str = 'NAIPE'

# Migrando de database, se forem apenas dados, sem métodos, pode usar
# namedtuples ao invés de classes (e se não precisar mudar)
# Carta = namedtuple(
#     'Carta', ['valor', 'naipe'],
